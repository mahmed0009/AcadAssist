...
class CurrencyHistoryPage extends StatefulWidget {
  ...
  @override
  CurrencyHistoryPageState createState() {
    return CurrencyHistoryPageState();
  }
}

class CurrencyHistoryPageState extends State<CurrencyHistoryPage> {
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final from = item['fromCurrency'];
                final to = item['toCurrency'];
