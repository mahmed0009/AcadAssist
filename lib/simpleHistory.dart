...
class SimpleHistoryPage extends StatefulWidget {
  const SimpleHistoryPage({super.key});

  @override
  SimpleHistoryPageState createState() {
    return SimpleHistoryPageState();
  }
}

class SimpleHistoryPageState extends State<SimpleHistoryPage> {
