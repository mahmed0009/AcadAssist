...
import 'package:project/cgpaHistory.dart';
...
class _CgpaCalculatorState extends State<CgpaCalculator> {
 // bool isDarkMode = false;
  ...
  void saveCalculationHistory(String GpaText) async {
    try {
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CgpaHistoryPage(),
                  ),
                );
              },
            ),
              ...
              children: [
                GestureDetector(
                  ...
                  onTap: () {
                    ...
                    saveCalculationHistory(GpaText);
                  },
                ),
                GestureDetector(
                  child: Container(
